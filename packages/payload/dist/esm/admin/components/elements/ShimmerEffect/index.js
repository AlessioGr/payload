...
import "./index.scss";
export var ShimmerEffect = function(param) {
...
export var StaggeredShimmers = function(param) {
    ...
    var _useDelay = _sliced_to_array(useDelay(renderDelay, true), 1), hasDelayed = _useDelay[0];
