...
var _getUniqueListBy = /*#__PURE__*/ _interop_require_default(require("../../../../../../../utilities/getUniqueListBy"));
...
var Iterable = function(param) {
    ...
    return /*#__PURE__*/ _react.default.createElement("div", {
    ...
    }, locale), (0, _getTranslation.getTranslation)(field.label, i18n)), maxRows > 0 && /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, Array.from(Array(maxRows).keys()).map(function(row, i) {
        ...
        if (field.type === "blocks") {
            ...
            if (((_versionRow = versionRow) === null || _versionRow === void 0 ? void 0 : _versionRow.blockType) === ((_comparisonRow = comparisonRow) === null || _comparisonRow === void 0 ? void 0 : _comparisonRow.blockType)) {
                ...
                subFields = (0, _getUniqueListBy.default)(_to_consumable_array(subFields).concat(_to_consumable_array(matchedVersionBlock.fields), _to_consumable_array(matchedComparisonBlock.fields)), "name");
            }
        }
        return /*#__PURE__*/ _react.default.createElement("div", {
            ...
            fields: subFields.filter(function(subField) {
                return !((0, _types.fieldAffectsData)(subField) && subField.name === "id");
            }),
