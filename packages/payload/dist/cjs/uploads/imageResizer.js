 ...
 */ var getSanitizedImageData = function(sourceImage) {
    ...
    var name = (0, _sanitizefilename.default)(sourceImage.substring(0, sourceImage.lastIndexOf(".")) || sourceImage);
    return {
        name: name,
        ext: extension
    };
...
function resizeAndTransformImageSizes(_) {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    sharpBase = (0, _sharp.default)(file.tempFilePath || file.data).rotate(); // pass rotate() to auto-rotate based on EXIF data. https://github.com/payloadcms/payload/pull/3081
                    return [
                        4,
                                ...
                                return _ts_generator(this, function(_state) {
                                    switch(_state.label){
                                        ...
                                        case 2:
                                            ...
                                            return [
                                                4,
                                                (0, _fileExists.default)(imagePath)
                                            ];
                                        case 3:
                                            if (_state.sent()) {
