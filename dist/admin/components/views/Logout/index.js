...
const Logout = (props) => {
    ...
    return (react_1.default.createElement(Minimal_1.default, { className: baseClass },
        ...
        react_1.default.createElement("div", { className: `${baseClass}__wrap` },
            ...
            react_1.default.createElement(Button_1.default, { el: "anchor", buttonStyle: "secondary", url: `${admin}/login${originalUrl && originalUrl.length > 0 ? `?originalUrl=${encodeURIComponent(originalUrl)}` : ''}` }, t('logBackIn')))));
};
