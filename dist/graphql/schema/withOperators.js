...
const defaults = {
    number: {
        type: (field) => {
            ...
            return (field === null || field === void 0 ? void 0 : field.hasMany) === true ? new graphql_1.GraphQLList(type) : type;
        },
    ...
    relationship: {
        type: (field) => {
            return (field === null || field === void 0 ? void 0 : field.hasMany) === true ? new graphql_1.GraphQLList(graphql_1.GraphQLString) : graphql_1.GraphQLString;
        },
        operators: [...operators_1.default.equality, ...operators_1.default.contains],
    },
    upload: {
