...
declare function registerFirstUser<TSlug extends CollectionSlug>(args: Arguments<GeneratedTypes['collections'][TSlug]>): Promise<Result<GeneratedTypes['collections'][TSlug]>>;
