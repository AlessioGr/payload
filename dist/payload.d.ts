...
export declare class BasePayload<TGeneratedTypes extends GeneratedTypes> {
     ...
     */
    create: <T extends string>(options: CreateOptions<T>) => Promise<TGeneratedTypes["collections"][T]>;
    /**
     * @description Find documents with criteria
     * @param options
     * @returns documents satisfying query
     */
    find: <T extends string>(options: FindOptions<T>) => Promise<PaginatedDocs<TGeneratedTypes["collections"][T]>>;
    /**
     * @description Find document by ID
     * @param options
     * @returns document with specified ID
     */
    findByID: <T extends string>(options: FindByIDOptions<T>) => Promise<TGeneratedTypes["collections"][T]>;
    /**
     ...
     */
    findVersions: <T extends string>(options: FindVersionsOptions<T>) => Promise<PaginatedDocs<TypeWithVersion<TGeneratedTypes["collections"][T]>>>;
    /**
     * @description Find version by ID
     * @param options
     * @returns version with specified ID
     */
    findVersionByID: <T extends string>(options: FindVersionByIDOptions<T>) => Promise<TypeWithVersion<TGeneratedTypes["collections"][T]>>;
    /**
     * @description Restore version by ID
     * @param options
     * @returns version with specified ID
     */
    restoreVersion: <T extends string>(options: RestoreVersionOptions<T>) => Promise<TGeneratedTypes["collections"][T]>;
    login: <T extends string>(options: LoginOptions<T>) => Promise<LoginResult & {
        user: TGeneratedTypes["collections"][T];
    }>;
    forgotPassword: <T extends string>(options: ForgotPasswordOptions<T>) => Promise<ForgotPasswordResult>;
    resetPassword: <T extends string>(options: ResetPasswordOptions<T>) => Promise<ResetPasswordResult>;
    unlock: <T extends string>(options: UnlockOptions<T>) => Promise<boolean>;
    verifyEmail: <T extends string>(options: VerifyEmailOptions<T>) => Promise<boolean>;
