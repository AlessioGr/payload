...
export type Field<TSlug extends CollectionSlug = any> = TextField<TSlug> | NumberField<TSlug> | EmailField<TSlug> | TextareaField<TSlug> | CheckboxField<TSlug> | DateField<TSlug> | BlockField<TSlug> | GroupField<TSlug> | RadioField<TSlug> | RelationshipField<TSlug> | ArrayField<TSlug> | RichTextField<TSlug> | SelectField<TSlug> | UploadField<TSlug> | CodeField<TSlug> | JSONField<TSlug> | PointField<TSlug> | RowField<TSlug> | CollapsibleField<TSlug> | TabsField<TSlug> | UIField;
export type FieldAffectingData<TSlug extends CollectionSlug = any> = TextField<TSlug> | NumberField<TSlug> | EmailField<TSlug> | TextareaField<TSlug> | CheckboxField<TSlug> | DateField<TSlug> | BlockField<TSlug> | GroupField<TSlug> | RadioField<TSlug> | RelationshipField<TSlug> | ArrayField<TSlug> | RichTextField<TSlug> | SelectField<TSlug> | UploadField<TSlug> | CodeField<TSlug> | JSONField<TSlug> | PointField<TSlug> | TabAsField<TSlug>;
export type NonPresentationalField<TSlug extends CollectionSlug = any> = TextField<TSlug> | NumberField<TSlug> | EmailField<TSlug> | TextareaField<TSlug> | CheckboxField<TSlug> | DateField<TSlug> | BlockField<TSlug> | GroupField<TSlug> | RadioField<TSlug> | RelationshipField<TSlug> | ArrayField<TSlug> | RichTextField<TSlug> | SelectField<TSlug> | UploadField<TSlug> | CodeField<TSlug> | JSONField<TSlug> | PointField<TSlug> | RowField<TSlug> | TabsField<TSlug> | CollapsibleField<TSlug>;
export type FieldWithPath<TSlug extends CollectionSlug = any> = Field<TSlug> & {
    path?: string;
};
export type FieldWithSubFields<TSlug extends CollectionSlug = any> = GroupField<TSlug> | ArrayField<TSlug> | RowField<TSlug> | CollapsibleField<TSlug>;
export type FieldPresentationalOnly = UIField;
export type FieldWithMany<TSlug extends CollectionSlug = any> = SelectField<TSlug> | RelationshipField<TSlug>;
export type FieldWithMaxDepth<TSlug extends CollectionSlug = any> = UploadField<TSlug> | RelationshipField<TSlug>;
export declare function fieldHasSubFields(field: Field<any>): field is FieldWithSubFields<any>;
export declare function fieldIsArrayType(field: Field<any>): field is ArrayField<any>;
export declare function fieldIsBlockType(field: Field<any>): field is BlockField<any>;
...
export declare function fieldSupportsMany(field: Field<any>): field is FieldWithMany<any>;
export declare function fieldHasMaxDepth(field: Field<any>): field is FieldWithMaxDepth<any>;
export declare function fieldIsPresentationalOnly(field: Field<any> | TabAsField<any>): field is UIField;
export declare function fieldAffectsData(field: Field<any> | TabAsField<any>): field is FieldAffectingData<any>;
export declare function tabHasName(tab: Tab<any>): tab is NamedTab<any>;
export declare function fieldIsLocalized(field: Field<any> | Tab<any>): boolean;
