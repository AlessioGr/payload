...
const promise = async ({ data, doc, field, id, operation, overrideAccess, req, siblingData, siblingDoc, context, }) => {
    ...
    if ((0, types_1.fieldAffectsData)(field)) {
        ...
        if (field.access && field.access[operation]) {
            const result = overrideAccess ? true : await field.access[operation]({ req, id, siblingData, data: data, doc: doc }); // TODO: This can be better typed. Might need to add or omit id from FieldWithID somewhere
            if (!result) {
