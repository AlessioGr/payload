...
declare const _default: {
    number: Validate<unknown, unknown, NumberField<any>, any>;
    text: Validate<unknown, unknown, TextField<any>, any>;
    password: Validate<unknown, unknown, TextField<any>, any>;
    email: Validate<unknown, unknown, EmailField<any>, any>;
    textarea: Validate<unknown, unknown, TextareaField<any>, any>;
    code: Validate<unknown, unknown, CodeField<any>, any>;
    richText: Validate<unknown, unknown, RichTextField<any>, any>;
    checkbox: Validate<unknown, unknown, CheckboxField<any>, any>;
    date: Validate<unknown, unknown, DateField<any>, any>;
    upload: Validate<unknown, unknown, UploadField<any>, any>;
    relationship: Validate<unknown, unknown, RelationshipField<any>, any>;
    array: Validate<unknown, unknown, ArrayField<any>, any>;
    select: Validate<unknown, unknown, SelectField<any>, any>;
    radio: Validate<unknown, unknown, RadioField<any>, any>;
    blocks: Validate<unknown, unknown, BlockField<any>, any>;
    point: Validate<unknown, unknown, PointField<any>, any>;
    json: Validate<unknown, unknown, Omit<import("./config/types").FieldBaseType<any, string>, "admin"> & {
        admin?: {
            position?: "sidebar";
            width?: string;
